...
pub struct DeclarativeEnvironmentRecord {
    pub env_rec: boa_gc::Cell<FxHashMap<Sym, DeclarativeEnvironmentRecordBinding>>,
    pub outer_env: Option<Environment>,
}

impl DeclarativeEnvironmentRecord {
    pub fn new(env: Option<Environment>) -> Self {
        let _timer = Profiler::global().start_event("new_declarative_environment", "env");
        Self {
            env_rec: boa_gc::Cell::new(FxHashMap::default()),
            outer_env: env,
        }
    }
}
